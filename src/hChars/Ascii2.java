...
public class Ascii2 { //en esta parte mandamos llamar nuestro programa anterior o bien hacer la clase Ascii2
	...
	public static void main(String[] args) {
		for (char c = 'A'; c <= 'Z'; c++) //vamos a ejecutar un ciclo usando "char" donde nuestro objeto c, sera la letra A, entonces si A es menor o igual a Z se va a seguir ejecutando y sumando la siguiente letra
